...
export class RegistroeventsComponent {
  ...
  constructor(private formBuilder: FormBuilder, private _eventoService: EventosService, public router: Router) { }
      ...
      if (this.selectedFile) {
        ...
        this._eventoService.cargarImagen(formData)
          .subscribe(async (data: any) => {
            ...
            this._eventoService.imageUploaded = await data.url || '';
